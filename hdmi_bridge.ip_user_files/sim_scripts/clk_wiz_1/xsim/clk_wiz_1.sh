...
#
# Script generated by Vivado on Tue Aug 26 11:36:41 -0400 2025
...
simulate()
{
  xsim clk_wiz_1 -key {Behavioral:sim_1:Functional:clk_wiz_1} -tclbatch cmd.tcl -protoinst "protoinst_files/probes.protoinst" -log simulate.log
}
