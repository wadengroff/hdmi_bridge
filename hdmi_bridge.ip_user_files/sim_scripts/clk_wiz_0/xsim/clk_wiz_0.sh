...
#
# Script generated by Vivado on Thu Aug 07 23:27:34 -0400 2025
...
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/probes.protoinst" -log simulate.log
}
